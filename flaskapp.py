...
@app.route('/imageproject', methods=['GET','POST'])
def imageproject():
    ...
    return render_template('imageproject.html', form=form)
@app.route('/image')
def image():
    #return Response(generate_frames(path_x='static/files/bikes.mp4'), mimetype='multipart/x-mixed-replace; boundary=frame')
    return Response(generate_frames(path_x = session.get('image_path', None)),mimetype='multipart/x-mixed-replace; boundary=frame')
